...
public class StackQueue_solve3 {
...
//	모든 트럭의 무게는 1 이상 weight 이하입니다.
    ...
    public int solution(int bridge_length, int weight, int[] truck_weights) {
	    ...
	    for (Integer truckOne : truck_weights) {
			truck = truckOne;
			index = 0;
...
//		int[] truck_weights = {10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
		...
		StackQueue_solve3 s2 = new StackQueue_solve3();
		System.out.println(s2.solution(bridge_length, weight, truck_weights));
